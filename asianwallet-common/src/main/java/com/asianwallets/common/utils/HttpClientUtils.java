...
public class HttpClientUtils {
    ...
    public static JSONObject reqGet(String url, Map<String, Object> params, Map<String, Object> headMap) {
        ...
        log.info("【HttpClientUtils-reqGet】==> 【URL】:【{}】 【请求参数】: 【{}】 【headMap】: 【{}】", url, JSON.toJSON(params), JSON.toJSON(headMap));
        ...
        try {
            ...
            stream.close();
            log.info("【HttpClientUtils-reqGet】==> 【httpStatus】: 【{}】 【response】:: {}", httpStatus, JSON.toJSON(sb));
     ...
     * get请求
     */
    public static String reqGetString(String url, Map<String, Object> params, Map<String, Object> headMap) {
     ...
     */
    @SuppressWarnings("deprecation")
    public static String reqPostString(String url, Object params, Map<String, Object> headMap) {
        HttpResponse httpResponse = new HttpResponse();
        HttpClient client = new HttpClient();
        ...
        try {
            ...
            stream.close();
            log.info("[HttpClientUtils-reqPostString]==> httpStatus:{},response::{}", httpStatus, sb);
            if (httpStatus == HttpStatus.SC_OK) {
                return sb.toString();
            } else {
                return sb.toString();
            ...
            log.error("[HttpClientUtils-reqPostString]==>异常：{}", e.getMessage());
        }
        return null;
    }
     ...
     * get请求解析json对象
     */
    public static JSONObject reqGetRate(String url, Map<String, Object> params, Map<String, Object> headMap) {
        HttpClient client = new HttpClient();
        if (params != null && params.size() > 0) {
            url += "?";
            for (Entry<String, Object> entry : params.entrySet()) {
